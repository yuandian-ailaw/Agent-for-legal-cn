...
| 技能套件 | 描述 |
|---|---|
| [corporate-legal](corporate-legal.bundle.json) | 公司法务集群完整套件 |

> 单 plugin 分发包内通常只有一个 bundle。可读元数据见仓库根 `BUNDLE.md`；机器可读源见同目录 `corporate-legal.bundle.json` 与 `../catalog.json`。
