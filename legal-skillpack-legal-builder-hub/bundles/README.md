...
| 技能套件 | 描述 |
|---|---|
| [legal-builder-hub](legal-builder-hub.bundle.json) | Skillpack 管理 / Hub集群完整套件 |

> 单 plugin 分发包内通常只有一个 bundle。可读元数据见仓库根 `BUNDLE.md`；机器可读源见同目录 `legal-builder-hub.bundle.json` 与 `../catalog.json`。
