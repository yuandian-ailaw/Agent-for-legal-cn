...
| 技能套件 | 描述 |
|---|---|
| [legal-research-cn](legal-research-cn.bundle.json) | 中国法法律研究集群完整套件 |

> 单 plugin 分发包内通常只有一个 bundle。可读元数据见仓库根 `BUNDLE.md`；机器可读源见同目录 `legal-research-cn.bundle.json` 与 `../catalog.json`。
