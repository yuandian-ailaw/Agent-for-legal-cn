...
| 技能套件 | 描述 |
|---|---|
| [ai-governance-legal](ai-governance-legal.bundle.json) | AI 治理合规集群完整套件 |

> 单 plugin 分发包内通常只有一个 bundle。可读元数据见仓库根 `BUNDLE.md`；机器可读源见同目录 `ai-governance-legal.bundle.json` 与 `../catalog.json`。
